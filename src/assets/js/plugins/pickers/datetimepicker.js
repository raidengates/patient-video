(function ($) {
    ...
    $.fn.dateTimePicker = function (options) {
        ...
        return this.each(function () {
            ...
            elem.addClass("dtp_main has-feedback-right");
            ...
            function updateMainElemGlobal() {
                ...
                var $s = $('<span>');
                $s.text(lastSelected.format(settings.dateFormat));
                elem.empty();
                elem.append($s);
                $s = $("<a class='feedback'><img src = '/images/icons/ic-calendar.svg' /></a>");
                elem.append($s);
            ...
            elem.on('click', function () {
                ...
                if(offset.left + $content.width() <= window.innerWidth)
                    $content.css({ top: (offset.top + settings.positionShift.top) + "px", left: (offset.left + settings.positionShift.left) + "px" });
                else
                    $content.css({ top: (offset.top + settings.positionShift.top) + "px", left: (window.innerWidth - $content.width() + settings.positionShift.left) + "px" });
                ...
                function createMonthPanel(selectMonth) {
                    ...
                    var $s = $('<a><img src = "/images/icons/ic-arrow_left.svg" /></a>');
                    $s.addClass('ico-size-month hov');
                    ...
                    $d.append($s);
                    $s = $('<a><img src = "/images/icons/ic-arrow_right.svg" /></a>');
                    $s.addClass('ico-size-month hov');
                ...
                function attachChangeTime() {
                    var $angles = $($content).find('a[id^="angle-"]');
                ...
                function createTimer() {
                    ...
                    var $i = $('<a><img src = "/images/icons/ic-arrow_up.svg" /></a>');
                    $i.attr('id', 'angle-up-hour');
                    $i.addClass('ico-size-large hov');
                    $panel.append($i);
                    var $m = $('<span>');
                    $m.addClass('dtp_modal-midle');
                    $panel.append($m);
                    $i = $('<a><img src = "/images/icons/ic-arrow_up.svg" /></a>');
                    ...
                    $panel = $('<div>');
                    $panel.addClass('dtp_modal-append');
                    $i = $('<a><img src = "/images/icons/ic-arrow_down.svg" /></a>');
