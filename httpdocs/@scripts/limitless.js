function limitless_init() {
    ...
    //        $('.navbar-inverse').removeClass('bg-slate-800');
    //        $('.navbar-inverse').addClass('bg-white');
    //        $('.navbar-inverse .navbar-nav > li > a').addClass('text-slate-800');
    //        $('.navbar-brand > img').attr('src', 'images/logo_black.png');
    //    }
    //    else {
    //        $('body').attr('style', '');
    //        $('.navbar-inverse').addClass('bg-slate-800');
    //        $('.navbar-inverse').removeClass('bg-white');
    //        $('.navbar-inverse .navbar-nav > li > a').removeClass('text-slate-800');
    //        $('.navbar-brand > img').attr('src', 'images/logo_light.png');
    //    }
    //}
